...
| [docs/api.md](docs/api.md)                           | REST, filters, mutations, errors, GraphQL, search                 |
...
| [Releases](https://github.com/geoah/substrate/releases) | every released version, from its commit titles                 |
