...
it as a `recording`, and a Double click & hold also writes an `instruction`
the `assistant` agent turns into tasks, leaving its receipt on the
instruction. It requires
...
header, what lands and how to set the ring app up:
