/** The host-owned chrome a view or an app screen renders under: a header
 * with back and title, a segmented control for two screens or a bottom tab
 * bar for three to five, and the ONE primary button pinned above the safe
 * area and above the tabs, hidden while a text input has focus so the
 * keyboard never covers a button that cannot be reached. Under 768 px the
