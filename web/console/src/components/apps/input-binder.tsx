/** The picker an app shows when an input is ambiguous: two or more records of
 * the input's kind, no binding and no `default`. A pick writes
 * `bindings.<name>` on the app record itself, the owner's choice surviving a
 * re-install because install merges. */
