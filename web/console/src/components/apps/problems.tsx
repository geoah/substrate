/** What an app says about itself when the row is wrong. `ProblemList` stands
 * in for a frame the errors block; `ProblemStrip` sits above a frame the
  ...
  return (
    <Empty className="py-10">
      <EmptyHeader>
        ...
        <EmptyDescription>
          Fix the record and it runs on the next save.
        </EmptyDescription>
      </EmptyHeader>
      <EmptyContent>
    ...
    >
      ...
      >
        ...
        <span className="min-w-0 flex-1 truncate">
          {problems.length === 1
            ? problems[0].message
            : `${problems.length} warnings on this app`}
        </span>
        <ChevronDownIcon
          className={cn(
