...
export const MR_COLLECTION = "recordmergerequest"
...
export function mergeRequestQueryOptions(id: string) {
  return recordQueryOptions(CORE_AUTHORITY, MR_COLLECTION, id)
}
...
export function submitVerdict(
  ...
  return request<SubstrateRecord>(
    "PATCH",
    `${collectionPath(CORE_AUTHORITY, MR_COLLECTION)}/${seg(id)}`,
