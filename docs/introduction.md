...
| Term           | What it is                                                                                                                                                   |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **User**       | A human principal: a username, a password, and a TOTP second factor. An invite code, configured on the service as `SUBSTRATE_INVITE_CODE`, gates who may register; a local substrate has none. A user owns exactly one repository. |
