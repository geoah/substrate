...
| [0021](0021-account-is-an-owner-edge-on-shared-kinds-and-a-string-on-mirrors.md) | `account` is an optional owner edge on shared kinds and a provenance string on mirrors | accepted |
