...
| [0053](0053-a-retired-name-is-declared-and-never-inferred-from-a-prune.md) | A retired name is a declared reservation, never inferred from a prune | accepted |
>>>>>>> 8dc9f494 (docs(decisions): retire a name by declaration, never by prune (0053))
