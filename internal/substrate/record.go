...
type Record struct {
	ID string `json:"id"`
	// Kind is the record's kind REFERENCE, always fully qualified
	// (decision 0042): "samples.substrate.reamde.dev/calendar/calendarevent".
	...
	// "nothing has linked yet" (decision 0086).
