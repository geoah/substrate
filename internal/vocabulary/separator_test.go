...
func TestSeparatorWithContentIsRefused(t *testing.T) {
	in := "--- {kind: substrate.reamde.dev/core/actor, metadata: {id: api}, data: {authority: substrate.reamde.dev, package: core}}\n"
	...
	ok := "---\nkind: substrate.reamde.dev/core/actor\nmetadata: {id: api}\ndata: {authority: substrate.reamde.dev, package: core}\n"
