...
| OCC-01 | the occurrences read (decision 0043): a daily-forever dosing schedule of a kind the case declares itself computes its 7 slots a week beside the calendar's rows, stamped series stay silent inside their materialized span, a logged dose annotates without suppressing, and a travel week moves via exdates + rdates | | implemented |
