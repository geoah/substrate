...
// An inbound webhook end to end: the delivery a request becomes, the retry a
// parked delivery replays, and how the public door names the repository on
// the two paths that are not the happy one.
