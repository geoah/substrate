...
func TestOpenFailsClosedWithoutSafeRoles(t *testing.T) {
	...
	if _, err := Open(ctx, dsn, WithKindsDir("../../kinds/core.substrate.reamde.dev")); err == nil {
	...
	svc, err := Open(ctx, dsn, WithKindsDir("../../kinds/core.substrate.reamde.dev"), WithInsecureAllowSuperuser())
	if err != nil {
